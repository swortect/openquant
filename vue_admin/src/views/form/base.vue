...
export default {
    setup() {
        ...
        const API_KEY = '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'

        async function getGPT3Response(prompt:any) {
        ...
        formData.append('model', 'pt-3.5-turbo');
