<template>
  ...
  <lay-layer type="drawer" v-model="chatBoxVisible" title="">

  <lay-tab type="brief" v-model="current2" style="margin-top: 0;">
        <lay-tab-item title="对话" id="1">    
          <div class="chatBox">
      <div class="content">
        content
      </div>
      <lay-textarea placeholder="请输入描述" class="footer"></lay-textarea>
  </div>
</lay-tab-item>
        <lay-tab-item title="收藏" id="2"><div style="padding:20px">选项二</div></lay-tab-item>
  </lay-tab>
...
export default {
  ...
  setup() {
    ...
    const changeChatBoxVisible = function() {
